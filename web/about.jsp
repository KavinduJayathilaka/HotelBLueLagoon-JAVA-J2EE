            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">Blue Lagoon</span></h1>
                        <p class="mb-4">
                            Blue Lagoon Hotel offers ultimate comfort and luxury.
                            This 4-storied hotel is a beautiful combination of traditional grandeur and modern facilities.
                            The 100 exclusive guest rooms are furnished with a range of modern amenities such as television and internet access, a private bathroom with shower, a TV,
                            and free tea and coffee facilities are provided in each bright room.
                            Whether traveling for business or pleasure, your stay at the Blue Lagoon is sure to be more comfortable, productive and enjoyable than ever before.
                        </p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="rounded shadow overflow-hidden">
                            ...
                            <div class="text-center p-4 mt-3">
                                <h5 class="fw-bold mb-0">Mr. Jude De Silva</h5>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom">Group 27</a>
                        </div>
