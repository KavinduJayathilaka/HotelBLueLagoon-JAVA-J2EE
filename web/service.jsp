                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="gallery/rooms/index.html">
                            ...
                            <p class="text-body mb-0">we offer you the most luxurious rooms in our hotel than any other hotel.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <a class="service-item rounded" href="gallery/food/index.html">
                            ...
                            <p class="text-body mb-0">Choose between many cuisines from our highly skilled chefs.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="service-item rounded" href="gallery/spa/index.html">
                            ...
                            <p class="text-body mb-0">Brings you the best luxury Ayurveda products to help relax and rejuvenate to soothe your mind.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <a class="service-item rounded" href="gallery/sport/index.html">
                            ...
                            <p class="text-body mb-0">Enjoy your wonderful vacation with over 30 sports to choose between in our sports club.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="service-item rounded" href="gallery/event/index.html">
                            ...
                            <p class="text-body mb-0">Book your event in our amazing banquet halls and reception hall to get an unique luxury experience.</p>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <a class="service-item rounded" href="gallery/gym/index.html">
                            ...
                            <p class="text-body mb-0"> Our state-of-the-art gym floor has a wide range of cardio, free weights,  plate loaded, pin loaded, and functional training best calss .</p>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xxl testimonial mt-5 py-5 bg-dark wow zoomIn" data-wow-delay="0.1s" style="margin-bottom: 90px;">
            <div class="container">
                <div class="owl-carousel testimonial-carousel py-5">
                    ...
                    <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                        <p> The food was fabulous, the staff extremely helpful. <br>Recomended!</p>
                        <div class="d-flex align-items-center">
